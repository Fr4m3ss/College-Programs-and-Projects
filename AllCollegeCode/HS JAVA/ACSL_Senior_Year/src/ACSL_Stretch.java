	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		if(start+1==1||(start)%(array[0].length)==0)
		{
			while(((start+1)%array[0].length)!=0)
			{
				...
				if(nextplaced==6&&start%array[0].length!=0)
				{
		...
		else
		{
			...
			while(((start)%array[0].length)!=0)
			{
				...
				if((start-1)%array[0].length==0)
					break;
				if(start-1%array[0].length!=0&&nextplaced==2&&lastplaced!=3&&0!=((start-1)%(array[0].length))&&0!=(start%(array[0].length))&&start-1!=1)
				{
				...
				if((start-1)%array[0].length==0)
					break;
				if(start-1%array[0].length!=0&&nextplaced==3&&lastplaced!=2&&lastplaced!=5&&0!=((start-1)%(array[0].length))&&0!=(start%(array[0].length))&&start-1!=1)
				{
				...
				if((start-1)%array[0].length==0)
					break;
				if(start-1%array[0].length!=0&&nextplaced==4&&0!=(start%(array[0].length))&&start-1!=1)
				{
				...
				if((start-1)%array[0].length==0)
					break;
				if(start-1%array[0].length!=0&&nextplaced==5&&lastplaced!=2&&0!=((start-1)%(array[0].length)))
				{
...
public static String [][] placeDlr(String array[][],int s){
	for (int i = 0; i < array.length; i++) {
		for (int j = 0; j < array[i].length; j++) {
			if(
			(i+1)*array[0].length<=array.length*array[0].length
			&&(i+2)*array[0].length<=array.length*array[0].length
			&&(j+1)%(array[0].length+1)!=0
			&&array[i][j].equals(Integer.toString(s+1))
			&&array[i][j+1].equals(Integer.toString(s+2))
			&&array[i+1][j+1].equals(Integer.toString(s+2+array[0].length))
			&&(i+2)<array.length
			&&array[i+2][j+1].equals(Integer.toString(s+2+array[0].length+array[0].length)))
			{
				array[i][j]=" @";
				array[i][j+1]=" @";
				array[i+1][j+1]=" @";
