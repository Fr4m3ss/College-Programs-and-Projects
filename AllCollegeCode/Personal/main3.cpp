...
/* sets up user*/
void initUser(const User&);
/* sets up description */
/*User selects an action*/
void promptUserAction(const User&,Room rooms[], string &strCh);
/*implement Users Action*/
void implementUserAction(const User&,Room rooms[],const string& strCh);
